...
export function LetterScenePlaceholder() {
      ...
      <Card className="w-full flex flex-col items-center gap-4 py-8">
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-sm text-brand-cream-200/80 max-w-xs mx-auto">
            A quiet personal letter from {birthdayConfig.sender.name}.
          </p>
        </div>
        ...
        <div className="w-full bg-brand-purple-950/70 rounded-xl p-3.5 border border-brand-white-translucent text-left text-xs text-brand-cream-200/70 space-y-1">
          <div><strong className="text-brand-gold-300">Scene Name:</strong> Personal Letter</div>
          <div><strong className="text-brand-gold-300">Scene ID:</strong> <code>letter</code></div>
          <div><strong className="text-brand-gold-300">Progress:</strong> Scene 7 of {totalScenes}</div>
          <div><strong className="text-brand-gold-300">Paragraphs:</strong> {birthdayConfig.letter.paragraphs.length} paragraphs</div>
          <div><strong className="text-brand-gold-300">Sign-off:</strong> {birthdayConfig.letter.signature}</div>
        </div>
